    ...
    <div className="flex flex-col items-center justify-start min-h-screen bg-gray-100">
      ...
      <div className="relative bg-white rounded-3xl shadow-lg w-[90%] p-6 overflow-hidden">
        ...
        <div className="absolute bottom-4 left-4 bg-gray-800 text-white p-3 rounded-md">
          <p className="font-bold md:text-[20px]">{destaques[index].product_name}</p>
          <p className="text-green-400 md:text-[20px]">Preço: R$ {destaques[index].product_price}</p>
        </div>
      </div>
      ...
      <div className="flex gap-2 mt-4">
        {destaques.map((_, i) => (
          <button
            ...
            className={`w-3 h-3 rounded-full md:w-5 md:h-5 cursor-pointer ${
      ...
      <div className='w-full flex justify-center items-center flex-col bg-gray-200 rounded-md p-9 shadow-sm mt-14'>
        ...
        <p className='text-xl md:text-[22px] text-gray-700 mt-3'>Explore nossa loja e encontre tudo o que você precisa em um só lugar!</p>
      </div>
    </div>
  );
};
